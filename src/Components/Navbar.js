...
export const Navbar = () => {
  return (
    ...
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      {/* <Link to='/signup' className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base  md:mt-0  text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">Signup
